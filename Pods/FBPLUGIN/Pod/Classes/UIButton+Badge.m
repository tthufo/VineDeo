...
- (void)badgeInit
{
    ...
    [self.badge withBorder:@{@"Bwidth":@(1),@"Bcolor":[UIColor whiteColor]}];
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"10000000"] && self.shouldHideBadgeAtZero)) {
        [self removeBadge];
    } else if (!self.badge) {
